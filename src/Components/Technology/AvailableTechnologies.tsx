...
const AvailableTechnologies = ({ TechnologySection }: AvailableTechnologiesProps) => {
    ...
    return (
        <div className="grid grid-cols-[3fr_1fr] gap-6 mt-10">
...

                {
                    TechnologySection.map((Technology: ITechnology) => {
                        return <div key={Technology.id}>
                            ...
                            <div className="card bg-base-100 w-full shadow-sm container mx-auto px-4 py-4">
                                ...
                                <div className="flex items-center gap-4 justify-between">
                                    <p className="border-0 bg-[#F1F5F9] p-1 rounded-md mt-5 mb-5">
                                        {Technology.category}
                                    </p>
            ...
            <div>
                <YourStack TechnologySection={TechnologySection} />
            </div>
